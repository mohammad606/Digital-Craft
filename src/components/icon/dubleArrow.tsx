const DubleArrow = ({props}: { props: string }) => {
    return (
          <svg xmlns="http://www.w3.org/2000/svg" className={`${props}`} viewBox="0 0 12 24">
              <defs>
                  <path id="weuiArrowOutlined0" fill="#fff"
